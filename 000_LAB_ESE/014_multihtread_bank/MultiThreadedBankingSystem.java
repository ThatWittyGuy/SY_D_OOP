...
class BankAccount {
   ...
   public synchronized void deposit(double amount) {
       balance += amount;
       System.out.println(Thread.currentThread().getName() + " deposited $" + amount + " to Account " + accountNumber + ". New balance: $" + balance);
   }


   public synchronized boolean withdraw(double amount) {
       if (amount > balance) {
           System.out.println(Thread.currentThread().getName() + " tried to withdraw $" + amount + " from Account " + accountNumber + " but insufficient funds.");
           return false;
       }
       balance -= amount;
