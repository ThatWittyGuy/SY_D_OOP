...
// BEFORE ACID PROPERTIESSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSS
// package gui;
...
public class PatientPanel extends JFrame {
    ...
    public PatientPanel() {
        ...
        addButton.addActionListener(e -> {
            try (Connection con = DBConnection.getConnection()) {
                // Begin transaction
                con.setAutoCommit(false);  // Disable auto-commit to begin transaction
                try {
                    String sql = "INSERT INTO patient (name, age, gender, contact, address) VALUES (?, ?, ?, ?, ?)";
                    PreparedStatement stmt = con.prepareStatement(sql);
                    stmt.setString(1, nameField.getText());
